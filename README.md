...
- `GEMINI_DEFAULT_MODEL` - Sets the default Gemini model (e.g., `gemini-3-pro-preview`, `gemini-3-flash-preview`)
...
- **`ask-gemini`**: Asks Google Gemini for its perspective. Can be used for general questions or complex analysis of files.
  ...
  - **`model`** (optional): The Gemini model to use. Defaults to `gemini-3-pro-preview`. You can specify alternative models like `gemini-3-flash-preview` for faster responses.
